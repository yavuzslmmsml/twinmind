    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex mb-4 gap-3">
          <input type="text" class="form-control w-250px" id="searchInput" placeholder="Search notifications..." />
        ...
        <table class="table table-bordered align-middle" id="notificationsTable">
          ...
          <tbody id="notificationsBody">
             <?php
                       ...
                       global $conn;
                        foreach ($Messages as $MessagesDetails) {
                              dd($MessageDetails["recipient_role"]);
                            $q = "SELECT * FROM roles where 'role_id'= '".$MessagesDetails["recipient_role"]."'" ;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!--begin::Badges-->
                                    <div class="badge badge-light-danger"><?= $role_name ?></div>
                                    <!--end::Badges-->
                                </td>
