														...
														<tbody>
															<tr>
																...
																<td class="w-150px w-md-175px">
																	<a href="messages/reply" class="d-flex align-items-center text-gray-900">
																		<!--begin::Avatar-->
																...
																<td>
																	<div class="text-gray-900 gap-1 pt-2">
																		<!--begin::Heading-->
																		<a href="apps/inbox/reply.php" class="text-gray-900">
															...
															<tr>
																...
																<td class="w-150px w-md-175px">
																	<a href="apps/inbox/reply.php" class="d-flex align-items-center text-gray-900">
																		<!--begin::Avatar-->
																		<div class="symbol symbol-35px me-3">
