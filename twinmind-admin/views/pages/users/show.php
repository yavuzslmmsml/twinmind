...
<div class="card mb-5 mb-xl-8">
    <div class="card-body text-center">
        ...
        <!--end::User Image-->
        <h3 class="mb-2">Emma Smith</h3>
        <div class="mb-4">
            <div class="badge badge-lg badge-light-primary">Instructor</div>
        </div>

        <!--begin::Stats Container-->
        <div class="d-flex justify-content-center gap-4">
            <div class="border border-gray-300 border-dashed rounded py-3 px-5 text-center">
                <div class="fs-2 fw-bold text-primary"><?= $totalStudents ?? '123'; ?></div>
                <div class="fs-7 fw-semibold text-muted">Toplam Öğrenci</div>
            </div>
            <div class="border border-gray-300 border-dashed rounded py-3 px-5 text-center">
                <div class="fs-2 fw-bold text-primary"><?= $totalCourses ?? '15'; ?></div>
                <div class="fs-7 fw-semibold text-muted">Toplam Kurs</div>
            </div>
        </div>
        <!--end::Stats Container-->
    </div>
