                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="/user-profile/overview" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="/user-profile/settings" class="menu-link">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <div class="symbol-label fs-3 bg-light-primary text-primary">
                            <?php $ilkHarf = 'G'; // Varsayılan harf

                            if (isset($_SESSION['user'])) {
                                $name = $_SESSION['user']['name'];
                                $ilkHarf = strtoupper(substr($name, 0, 1));
                            }
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        <?php echo isset($_SESSION['user']) ? $_SESSION['user']['email'] : 'Misafir'; ?>
                                    </div>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="/account/security" class="menu-link px-5">
                                <span class="menu-icon me-2">
                        ...
                        <div class="menu-item px-5">
                            <form action="/auth/signout" method="POST" id="logout-form">
                                <button type="submit" class="menu-link px-5 w-100"
                                    ...
                                    <span class="menu-icon me-2">
                                        <i class="ki-duotone ki-logout fs-3 text-danger">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                    </span>
                                    <span class="menu-title text-danger">Çıkış Yap</span>
                                </button>
                            </form>
                        </div>
                        <!--end::Menu item-->
